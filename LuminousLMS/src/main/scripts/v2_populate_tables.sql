...
START TRANSACTION;
USE `eolms`;
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (1, 'UNREAD', 1, 3, 'This is a test Subject 1', 'This is a test message from the database to be shown to the Consultant from Client', '2017-10-02 09:10:00', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (2, 'UNREAD', 3, 1, 'This is a test Subject 2', 'This is a test message 2 for Client from Consultant', '2017-10-03 11:13:01', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (3, 'UNREAD', 3, 1, 'This is a test Subject 3', 'This is a test message 3 for Client from Consultant', '2017-10-04 12:15:04', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (4, 'UNREAD', 3, 1, 'This is a test Subject 4', 'This is a test message 4 for Client from Consultant', '2017-10-05 13:17:09', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (5, 'UNREAD', 3, 1, 'This is a test Subject 5', 'This is a test message 5 for Client from Consultant', '2017-10-10 14:19:16', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (6, 'UNREAD', 1, 3, 'This is a test Subject 6', 'This is a test message 2 from the database to be shown to the Consultant from Client', '2017-10-11 15:21:25', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (7, 'UNREAD', 1, 3, 'This is a test Subject 7', 'This is a test message 7 from the database to be shown to the Consultant from Client', '2017-10-12 16:23:36', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (8, 'UNREAD', 1, 3, 'This is a test Subject 8', 'This is a test message 8 from the database to be shown to the Consultant from Client', '2017-10-13 09:25:49', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (9, 'UNREAD', 10, 8, 'This is a test Subject 9s', 'This is a test message 9 sent from the consultant Hugh to client Manual', '2017-10-16 10:28:04', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (10, 'UNREAD', 8, 10, 'This is a test Subject 9r', 'This is a test message 9 reply from the client Manual to consultant Hugh', '2017-10-17 11:33:21', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (11, 'UNREAD', 3, 5, 'This is a test Subject 10s', 'This is a test message 10 sent from the consultant Connie to client Arnold', '2017-10-18 12:39:40', 'EST');
INSERT INTO `eolms`.`messages` (`id`, `status`, `fromid`, `toid`, `subject`, `message`, `createdate`, `timezone`) VALUES (12, 'UNREAD', 5, 3, 'This is a test Subject 10r', 'This is a test message 10 reply from the client Arnold to consultant Connie', '2017-10-19 13:48:01', 'EST');
