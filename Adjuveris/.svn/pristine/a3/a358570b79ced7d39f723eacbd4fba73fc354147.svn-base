...
public class LatinContainer extends ExercisesContainer implements LatinData{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8478469142839786324L;
	
	static List<String> boxes = Arrays.asList(new String[] {"pos", "var1", "var2", "var3", "var4", });
	static int indexLbl = indexLatinLabel;
	static int indexText = indexLatinText;
	Label lblVar;//6
	TextField<String> Vartf;//7

	public LatinContainer(String id, int questionId) {
		super(id, questionId);
		// TODO Auto-generated constructor stub
	}

	public LatinContainer(String id, IModel<?> model, int questionId) {
