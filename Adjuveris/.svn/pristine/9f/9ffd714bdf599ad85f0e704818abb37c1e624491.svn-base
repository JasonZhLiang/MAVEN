...
var selArr = [[["servo","servas","servat","servamus","servatis","servant",
	...
	[["faco","facis","facit","facimus","facitis","facunt",
	"facam","facas","facat","facamus","facatis","facant",
	"facor","faceris","facitur","facimur","facimini","facuntur",
	"facar","facaris","facatur","facamur","facamini","facantur"],
	...
	"faciebar","faciebaris","faciebatur","faciebamur","faciebamini","faciebantur",
	"facerer","facereris","faceretur","faceremur","faceremini","facerentur"],

	["faciam","facies","faciet","faciemus","facietis","facient",
	"--","--","--","--","--","--",
	"faciar","facieris","facietur","faciemur","faciemini","facientur",
	"--","--","--","--","--","--"],
	...
	["ferabam","ferabas","ferabat","ferabamus","ferabatis","ferabant",
	"ferrem","ferres","ferret","ferremus","ferretis","ferrent",
	"ferabar","ferabaris","ferabatur","ferabamur","ferabamini","ferabantur",
...
"latus eram","latus eras","latus erat","lati eramus","lati eratis","lati erant",
	"latus essem","latus esses","latus esset","latus essemus","latus essetis","latus essent"],
