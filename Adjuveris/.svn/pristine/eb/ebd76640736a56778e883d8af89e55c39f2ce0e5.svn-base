...
public class TreeExpansion<T> extends CheckBoxMultipleChoice
{
	...
	public TreeExpansion(String formIdIn, int userIdIn, int modeIn)
	{
		super("tree");
...
//		Integer institutionId = userService.findInstIdByUserId(userId);
	...
	{	
		...
		//{
			...
			//{
				//selectedClasses.add(ecmAll);
			selectedClasses.add(new EntityClassModel(1, "Latin 101", null, /*Date startdate, Date enddate, */1));
			selectedClasses.add(new EntityClassModel(2, "Latin 102", null, /*Date startdate, Date enddate, */1));
			selectedClasses.add(new EntityClassModel(3, "Latin 103", null, /*Date startdate, Date enddate, */1));
			//}
		//}
