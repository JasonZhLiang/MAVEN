...
/**
 * Entity implementation of the TeacherPreResultsModel interface
 * @author George
 */

@Entity
@Table(name="teacher_pre_results")
public class EntityTeacherPreResultsModel implements TeacherPreResultsModel{
	...
	public EntityTeacherPreResultsModel() {
	}
	
	public EntityTeacherPreResultsModel(Integer teacherId, 
