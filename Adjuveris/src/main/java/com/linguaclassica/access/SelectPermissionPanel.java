...
public class SelectPermissionPanel extends Panel
{
	...
	public SelectPermissionPanel()
	{
		...
		add(new SelectPermissionForm(0));
	}

	class SelectPermissionForm extends Form<Object>
	{
		private static final long serialVersionUID = 1L;
		
		private InstUserPermissionEntity destinationIUP;
		
		public SelectPermissionForm(Integer iupId)
		{
			super("selpermform");
		...
		{
			System.out.println("SelectPermissionForm.onSubmit");
			...
			{
				System.out.println("SelectPermissionForm.onSubmit unchecked Permission type.");
			}
		}
	}
}
